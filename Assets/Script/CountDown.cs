...
{
    [System.Serializable] private class CountDownEvent : UnityEvent { }
    ...
    [SerializeField] private int maxFontSize;    //폰트의 최대 크기
    [SerializeField] private int minFontSize;    //폰트의 최소 크기
